...
class MatrixFactorizationRecommender:
    def __init__(self, n_factors=50):
        ...
        (user_item_matrix, dic_int_to_userID,dic_userID_to_int,dic_int_to_newsID,
         dic_newsID_to_int)= build_user_item_matrix(filter_acitve_users=True,history_len=15,nbr_interaction=15)
    ...
    def recommend(self, user_id, n_recommendations=200, unrelevant_items = []):
