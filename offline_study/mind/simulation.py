...
itemID_categories_dict_vectors = dict(zip(item_df["NewsID"],item_df["vectors"]))
itemID_categories_dict = dict(zip(item_df["NewsID"],item_df["Category"]))
...
def simulate_adaptive_diversification(user_id,target_diversity,controller_type ,controller_param,
    ...
    if show_stages:
        ...
        print(dict(zip(categories,ast.literal_eval(userID_preferences_dict[user_id]))))
    ...
    for n in tqdm(range(n_steps)):
        ...
        if show_stages: 
            print([itemID_categories_dict[item] for item in recommended_items ])
        ...
        if show_stages:
            ...
            if user_choice != 'No_choice':
                print(itemID_categories_dict[user_choice])
            else:
                print(user_choice)
            print("  ")
        ...
        if user_choice != 'No_choice':
            ...
            matrix_factorization_RS.update(user_id, user_choice)
