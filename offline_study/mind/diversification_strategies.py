...
from diversity_metrics import compute_next_shannon_entropy, categories, shanon_entropy, compute_user_items_per_category
...
def compute_Ki(user_id,Kp,wanted_diversity,theta):
    ...
    H_n = shanon_entropy(compute_prob(item_per_category))
